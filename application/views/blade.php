...
<html class="fuelux" lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="public/assets/weather-icons/weather-icons.min.css">

        <link rel="stylesheet" type="text/css" href="public/assets/effects/menu-effects.css">
        ...
        <!-- Assets -->
        <link rel='stylesheet' type='text/css' href='public/assets/jquery-ui/ui-lightness/jquery-ui-1.10.3.custom.css' />
        <link rel='stylesheet' type='text/css' href='public/assets/morrischarts/morris.css' />
        <link rel='stylesheet' type='text/css' href='public/assets/fullcalendar/fullcalendar.css' />
        <link rel='stylesheet' type='text/css' href='public/assets/datatables/jquery.dataTables.css' />
        <link rel='stylesheet' type='text/css' href='public/assets/icheck/flat/_all.css' />

        <!-- Theme Styles -->
        <link rel="stylesheet" type="text/css" href="public/css/styles-less.css">
        <link rel="stylesheet" type="text/css" href="public/css/responsive.css">
        <link rel="stylesheet" type="text/css" href="public/css/animate.css">
        <link rel="stylesheet" type="text/css" href="_demo/demo.css">

  <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="public/assets/flotcharts/excanvas.min.js"></script><![endif]-->
            ...
            <div class="sidebar">
                ...
                <div class="sidebar-profile">
                    <div class="user-avatar">
                        <img src="_demo/images/profile-60x60.jpg" alt="Samantha Lenna Wilson" />
                    </div>
                    <div class="user-info">
                ...
                <ul class="menu">
                    ...
                    <li class="parent purple">
                        ...
                        <ul class="child">
                            ...
                            <li>
                                <a href="index-horizontal-menu.html">Horizontal Menu Bar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="orange">
                    ...
                    <li class="parent lightyellow active">
                        <a href="">
                    ...
                    <div class="row breadcrumbs">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <ul class="breadcrumbs">
                                ...
                                <li><a href="#">Smart Form Elements</a></li>
                            </ul>
                        </div>
...
//        phpinfo(INFO_VARIABLES);
        ...
        <!-- Custom Scroll Bar -->
        <script src="public/assets/nicescroll/jquery.nicescroll.min.js"></script>

        <script src="public/assets/bootstrap/js/bootstrap.min.js"></script>
        <script src="public/assets/charts/table-to-chart.js"></script>
        <script src="public/assets/fullcalendar/fullcalendar.min.js"></script>
        <script src="public/assets/fullcalendar/gcal.js"></script>
        <script src="public/assets/sidebar/min-height.js"></script>
        ...
        <!-- jQuery UI -->
        <script src="public/assets/jquery-ui/jquery-ui-1.10.3.custom.min.js"></script>

        <!-- Morris Charts -->
        <script src="public/assets/morrischarts/raphael.js"></script>
        <script src="public/assets/morrischarts/morris.js"></script>

        <!-- iCheck -->
        <script src="public/assets/icheck/icheck2.js"></script>
        <script src="public/assets/icheck/icheck.js"></script>

        <!-- CountTo -->
        <script src="public/assets/jquery-countto/jquery.count-to.js"></script>

        <!-- FlotCharts  -->
        <script src="public/assets/flotcharts/flotcharts-common.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.resize.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.canvas.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.image.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.categories.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.crosshair.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.errorbars.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.fillbetween.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.navigate.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.pie.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.selection.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.stack.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.symbol.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.threshold.min.js"></script>
        <script src="public/assets/flotcharts/jquery.colorhelpers.min.js"></script>
        <script src="public/assets/flotcharts/jquery.flot.time.min.js"></script>

        <!-- Dashboard Charts -->
        <script src="_demo/icheck/icheck.js"></script>
        <script src="_demo/charts/dashboard.js"></script>
        <script src="_demo/all-pages.js"></script>

        <script type="text/javascript" src="https://www.google.com/jsapi"></script>
        <script type="text/javascript" src="_demo/page-index.js"></script>
